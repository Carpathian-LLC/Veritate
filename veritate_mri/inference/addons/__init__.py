...
# ------------------------------------------------------------------------------------
# Notes:
# - inference-time addon registry. each addon under
#   veritate_mri/inference/addons/<name>/ ships a manifest.json plus
#   addon.py exposing an Addon class with the contract:
#   reset(), observe(byte_int), bias_logits(logits) -> logits.
...
# veritate_mri/inference/addons/__init__.py
# ------------------------------------------------------------------------------------
# Imports:
