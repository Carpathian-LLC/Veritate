...
# - Tools live in veritate_mri/agent/tools/ as self-contained modules. Each
#   tool exports: name, description, args_schema, execute(args) -> str.
# - The loop is model-agnostic: it consumes any object that implements the
#   Brain.stream(prompt, constraint=...) interface.
# veritate_mri/agent/__init__.py
# ------------------------------------------------------------------------------------
# Imports:
