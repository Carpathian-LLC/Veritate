...
#   Four type-tiers of 50 each as JSONL at
#   veritate_mri/data/eval/grade/reasoning/<tier>.jsonl ({"prompt", "answer"}).
# - Tier categories (cognitive moves, not difficulty):
#     recall, pattern, deduction1, deduction_n
# - Usage:
#     python veritate_mri/training/builders/eval/build_reasoning_eval.py
# veritate_mri/training/builders/eval/build_reasoning_eval.py
# ------------------------------------------------------------------------------------
# Imports:
