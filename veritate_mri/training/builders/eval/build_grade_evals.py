...
#   Each band: ~8 KB passage tuned to that reading level's prose stats.
#   Sources at veritate_mri/data/eval/grade/sources/grade_<level>_source.txt;
#   encoded UTF-8 with normalized line endings and written as .bin.
# - Runs Flesch-Kincaid on every source; flags bands more than FK_TOLERANCE
#   off-target. The grade probe is only meaningful when each band sits at its
#   claimed reading level.
# - Usage:
#     python veritate_mri/training/builders/eval/build_grade_evals.py
# veritate_mri/training/builders/eval/build_grade_evals.py
# ------------------------------------------------------------------------------------
# Imports:
