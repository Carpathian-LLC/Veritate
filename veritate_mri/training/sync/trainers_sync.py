...
# ------------------------------------------------------------------------------------
# Notes:
# - downloads trainer files from the public Veritate-Trainers repo over plain
#   https. trainers/ is NOT a git repo locally; this is a one-way file pull.
...
#   models_sync.py.
# - .sync_state.json lives at trainers/.sync_state.json and stores the SHA of
...
def _parse_tarball(data):
    ...
    with tarfile.open(fileobj=io.BytesIO(data), mode="r:gz") as tar:
        for member in tar.getmembers():
            ...
            if sc.safe_dest(rel, PLUGINS_DIR) is None: continue
...
def status():
    ...
    return {
        ...
        "local_files":        sc.count_local_files(PLUGINS_DIR),
