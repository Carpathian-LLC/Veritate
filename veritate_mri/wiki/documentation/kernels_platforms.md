...
summary: Platform / arch matrix, tier ranking, dispatch wiring, per-platform bench targets.
---

> Source: `documentation/kernels/platforms.md` (mirrored copy; the file at that path remains the canonical contract).
