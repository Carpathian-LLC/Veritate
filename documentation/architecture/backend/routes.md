...
The Flask routing layer lives under [veritate_mri/routes/](../../../veritate_mri/routes/). Each module owns one concern, exports a single `register(app)` function, and is registered from [app.py:121–141](../../../veritate_mri/app.py#L121).
...
| [teacher_routes.py](../../../veritate_mri/routes/teacher_routes.py)      | Teacher (Ollama / API) configuration                                    |
| [train_routes.py](../../../veritate_mri/routes/train_routes.py)          | `/train/discovery`, `/train_stream` SSE                                 |
| [trainers_routes.py](../../../veritate_mri/routes/trainers_routes.py)    | Plugin listing, manifest, start/stop                                    |
