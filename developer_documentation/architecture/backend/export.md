...
- The trunk guard exists because the failure is silent: a hybrid checkpoint once exported to a garbage v9 bin (`models/chat80m_80m/veritate.bin`, kept as `veritate.bin.invalid_hybrid_export`) before the v13 path shipped.
