...
The `.bin` format is described under [developer_documentation/engine/](../../engine/) and supports versions v3 through v13 with progressively more features (MoE in v11, MTP in v12, hybrid trunk in v13, spec at [hybrid_trunk.md](../../engine/hybrid_trunk.md)). See [veritate_engine.md](veritate_engine.md).
