...
| Byte patching (SpaceByte-style boundary rule) | 3-6x effective train, 3-4x decode FLOPs | 250M at our FLOP class | v12 format needed | E2 built + smoked (`trunk=patched`), queued |
