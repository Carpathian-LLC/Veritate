...
- INT4 path (see [engine/reference.md](../engine/reference.md) for the `.bin` v4 format; the kernel-level source of truth is `veritate.h`'s `prepped_b_int4_t` block).
- MoE routing and per-expert dispatch (see [moe.md](moe.md)).
