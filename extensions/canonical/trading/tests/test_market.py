...
# ------------------------------------------------------------------------------------
# Notes:
# - Contract tests for the market data layer
#   (extensions/canonical/trading/server/data.py): the load-bearing correctness claims
#   the byte-model serving path depends on, namely timestamp-unit normalization and
#   no-lookahead resample boundaries.
# extensions/canonical/trading/tests/test_market.py
# ------------------------------------------------------------------------------------
# Imports:
