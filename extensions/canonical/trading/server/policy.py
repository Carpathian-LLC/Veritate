...
# - Fees are round-trip fractions; default 0.0020 = 20 bps spot taker. Passive/maker fills
#   are NOT modeled (momentum-style entries fill adversely; see market docs).
# extensions/canonical/trading/server/policy.py
# ------------------------------------------------------------------------------------
# Imports:
...
DEFAULTS = {
    ...
    "fee": 0.0020,              # round-trip fraction; 20 bps spot taker, matches veritate.ROUND_TRIP_FEE
