...
# extensions/canonical/trading/server/autotrader.py
# ------------------------------------------------------------------------------------
# Imports:
...
def main():
    ...
    p.add_argument("--mode", default="directional", choices=["directional", "vol_harvest"],
                   help="directional trades long/flat on the spot venue; vol_harvest emits straddles the spot broker cannot execute (flat)")
    p.add_argument("--fee_bps", type=float, default=20.0)
