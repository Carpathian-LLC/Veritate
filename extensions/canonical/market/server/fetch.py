...
# extensions/canonical/market/server/fetch.py
# ------------------------------------------------------------------------------------
# Imports:
...
def main(argv=None):
    ...
    Run: python extensions/canonical/market/server/fetch.py BTCUSDT ETHUSDT --bars 400000"""
    import argparse
    ...
    root = os.path.normpath(os.path.join(HERE, "..", "..", "..", "installed", "market", "data", args.source))
