...
#   tied LM head.
# - Plugins import via `from veritate.plugin import model` and use
#   `model.Veritate(...)`. Inference imports directly from veritate.model.
...
#   `veritate.qat.set_qat(model, True)`. State dict layout is unchanged so the
#   exporter and the C engine remain unaware of the flag.
# veritate/model.py
# ------------------------------------------------------------------------------------
