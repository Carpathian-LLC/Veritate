...
- Run: `models/chat200m_200m/` (steps 0-20400 one lineage). Curve: `train.csv`. Plan + gates: `developer_documentation/training/chat_model_200m_plan.md`. Chronology + throughput analysis: `worklog.md` 2026-07-08/09 and `research/06_training_throughput.md`.
