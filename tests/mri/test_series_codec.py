...
#   Covers bar format, return-bucket sign, sequence stride, clipping, the realized-vol,
#   session, buy-pressure, trade-activity, funding and sentiment channels, the
#   no-lookahead guarantee, and vectorized/scalar identity.
